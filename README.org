...
:END:
If you *really* want to donate, I would prefer you donate to each individual project. They are the ones
doing the real work, I just created a docker-compose file and a couple of bash scripts:
